...
2026-09-12 펫 개인화와 제한된 생성은 [ADR-0032](adr/0032-personal-pet-profiles.md)를 따른다.
...
이전하는 결정이 아니다. 실제 Tool allowlist와 전문 Agent 배치는
[`OperationalAgentExecutor`](../agent/src/runtime/executor.py)를 기준으로 한다.
