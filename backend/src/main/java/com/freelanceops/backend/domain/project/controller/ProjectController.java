...
public class ProjectController {
    ...
    @GetMapping
    public List<ProjectResponse> list(@PathVariable UUID workspaceId, @RequestParam(required = false) String search, Authentication authentication) {
        return projectService.list(userId(authentication), workspaceId, search);
    }
    ...
    public void delete(@PathVariable UUID workspaceId, @PathVariable UUID projectId, @RequestHeader(value = "traceparent", required = false) String traceparent, Authentication authentication) {
        projectService.delete(userId(authentication), workspaceId, projectId, trustedTraceparent(traceparent));
    }
